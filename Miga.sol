...
contract Miga is SafeMath {
    ...
    string public constant name = 'MIGA COIN';
    string public constant symbol = 'MIGA';
    //Default assumes totalSupply can't be over max (2^256 - 1).
    //you need multiply 10^decimals by your real total supply.
    uint256 public totalSupply = 10**1 * 10**uint256(decimals);
